...
@section('title', 'Create Your Skill')
@section('content')
<style>
.range-value{
    font-size:30px;
...
.percent-icon{
    ...
    <form action="{{ route('skill.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3 row">
                ...
                <input type="text" id="skill" class="form-control" name="skill" placeholder="Your skill">

        </div>
        <div class="mb-3 row">
            <div class="col-sm-11">
                <label for="percent" class="form-label">Percent</label>
                <input type="range" id="percent" class="form-range" name="percent" min="0" max="100">
